...
//             console.log(item);
//             var title = items.photo_title;
//             var url = location.photo_url;
//             var fileurl = location.photo_file_url;
...
//             '<img src="http://maps.google.com/intl/en_ALL/mapfiles/' +
//             'iw_panoramio.png"/></a><br/>' +
//             '<a href="' + location.owner_url + '" target="_blank">' + location.owner_name +
//             '</a></div></div><div><strong>Location:</strong><br/>Latitude: '+location.lat+',<br/>Longitude: '+location.lng+'</div>';
